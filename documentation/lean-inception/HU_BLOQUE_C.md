...
>
> **Estado:** Bloque C cerrado y aprobado. Bloques A, B, D y E previamente cerrados. Pendiente: Bloque F + HUs adicionales MVP2.
>
...
- **RNF de separación de roles:** el contenido expuesto en HU-11 (Operador) y el de F17 (Administrador) deben mantenerse separados en presentación, aunque puedan compartir fuente de datos. La separación es por presentación, no por datos.
...
Esta sesión cierra el Bloque C. A la fecha actual, los Bloques D y E también están cerrados; los siguientes bloques se redactarán en sesiones futuras:
...
3. **Bloque F — Gerente, reportería mínima** (F12, F13, F14 → ~3 HUs MVP1, incluye F30 inglobada).
